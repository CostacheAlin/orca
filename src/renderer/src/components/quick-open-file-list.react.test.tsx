...
describe('useRuntimeFileListForWorktree', () => {
  ...
  // #12547: the host stops at the shared cap whether or not it was asked to, so a full page is a
  // prefix. Reporting truncated:false unconditionally is what left the user with a silent partial list.
